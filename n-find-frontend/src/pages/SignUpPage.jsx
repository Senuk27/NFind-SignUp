...
>
               <Grid container>
                <Grid item lg={6} xl={6}  bgcolor={'#F9FFF3'} display={'flex' } justifyContent={'center'}>
                        <img src={signupImg} width={'80%'}  alt="Login" />
                    </Grid>
                    <Grid item lg={6} xl={6} borderRadius={5}  sx={{ maxHeight: '500px', overflowY: 'auto', '&::-webkit-scrollbar': { display: 'none' } }}>
   
                        <Grid item display={'flex'} justifyContent={'center'} alignItems={'center'}m={1}>
